...
export function ProjectWorkspacePage() {
  ...
  return <>
    <section className="w-full">
      ...
      <nav className="mt-7 flex gap-5 overflow-x-auto border-b border-slate-200" aria-label="Project navigation"><NavLink end to={`/projects/${project.project_key}`} className={tabClassName}>Overview</NavLink><NavLink to={`/projects/${project.project_key}/board`} className={tabClassName}>Board</NavLink><NavLink to={`/projects/${project.project_key}/sprints`} className={tabClassName}>Sprints</NavLink><NavLink to={`/projects/${project.project_key}/intelligence`} className={tabClassName}>AI Intelligence</NavLink><Link to={`/projects/${project.project_key}/reports`} className="inline-flex items-center border-b-2 border-transparent px-1 py-3 text-sm font-medium text-slate-500 hover:border-slate-300 hover:text-slate-800">Reports</Link></nav>
