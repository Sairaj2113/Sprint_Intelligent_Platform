  ...
  return (
    <section className="w-full">
      ...
      <section className="mt-6 rounded-xl border border-slate-200 bg-slate-50 px-5 py-4 sm:px-6">
        ...
        <p className="mt-1 text-base font-semibold text-slate-900">{project.name}</p>
        <p className="mt-1 font-mono text-xs text-slate-500">{project.project_key}</p>
      </section>

      <div className="mt-6">
        <IntelligenceQuestionForm question={question} onQuestionChange={setQuestion} />
